                        ...
                        <div class="view-order-page">
                            ...
                            <div class="">
                                ...
                                <div class="" ">
                                    ...
                                    <a style="margin-right: 20px; " data-form="https://pilot.paylink.sa/pay/info/{{$order->transaction_id}}" target="_blank" class="print-order-btn"> الدفع الان
                                    </a>
                                </div>
                            </div>
                                                ...
                                                @if(isset($order->wock_serials[$ind]))
                                                    ...
                                                    @for($k=0; $k<count($order->wock_serials[$ind]); $k++)
                                                        @if($order->wock_serial_txt[$ind][$k]==1)
                                                            ...
                                                            @endif
                                                        @else
                                                            <img width="100%" src="data:image/png;base64, {{ $order->wock_serials[$ind][$k] }}" alt="{{ $langg->lang320 }}  {{$i}}"/>
                                                        @endif
                                                    @endfor
