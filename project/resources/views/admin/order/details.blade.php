                                ...
                                <div class="col-lg-6">
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                @endif
                                                    ...
                                                    <th width="10%">:</th>
                                                    <td width="45%">{{$order->payment_status == 'Pending' ? "Unpaid":"Paid"}}</td>
                                        ...
                                        <select name="" class="process select order-droplinks {{ strtolower($order->status) }}">
                                                <option data-val="pending" {{ $order->status == 'pending' ? 'selected' : '' }} value="{{ route('admin-order-status',['id1' => $order->id, 'status' => 'pending']) }}" >{{ __('Pending') }}</option>
                                                <option data-val="processing" {{ $order->status == 'processing' ? 'selected' : '' }} value="{{ route('admin-order-status',['id1' => $order->id, 'status' => 'processing']) }}" >{{ __('Processing') }}</option>
                                                <option data-val="completed" {{ $order->status == 'completed' ? 'selected' : '' }} value="{{ route('admin-order-status',['id1' => $order->id, 'status' => 'completed']) }}" >{{ __('Completed') }}</option>
                                                <option data-val="declined" {{ $order->status == 'declined' ? 'selected' : '' }} value="{{ route('admin-order-status',['id1' => $order->id, 'status' => 'declined']) }}" >{{ __('Declined') }}</option>
                                            </select>
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                <tbody>
                                                            ...
                                                            <tr>
                                                                <th width="45%"><strong>{{ __('Adapter Name') }}:</strong></th>
                                                                <th width="10%">:</th>
                                            <td>{{$order->adapter_name}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th width="45%"><strong>{{ __('Transfer Amount') }}:</strong></th>
                                                                <th width="10%">:</th>
                                            <td width="45%">{{$order->transfer_amount}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th width="45%"><strong>{{ __('Transfer Date') }}:</strong></th>
                                                                <th width="10%">:</th>
                                            <td width="45%">{{$order->transfer_date}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th width="45%"><strong>{{ __('Transaction ID#') }}:</strong></th>
                                                                <th width="10%">:</th>
                                            <td width="45%">{{$order->transaction_id}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th width="45%"><strong>{{ __('رقم الجوال * سوا * ') }}:</strong></th>
                                                                <th width="10%">:</th>
                                            <td width="45%">{{$order->sawa_no}}</td>
                                                            </tr>
