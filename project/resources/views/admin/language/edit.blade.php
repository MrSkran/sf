...
@section('content')
 ...
 {{-- VENDOR PANEL ENDS --}}
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Transfer Date *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="transfer_date" placeholder="Transfer Date" required=""
                          value="{{ $lang->transfer_date }}">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="transfer_amount" placeholder="Transfer Amount" required=""
                          value="{{ $lang->transfer_amount }}">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Adapter name *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="adapter_name" placeholder="Adapter name" required=""
                          value="{{ $lang->adapter_name }}">
                      </div>
                    </div>
                      ...
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Show(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="show1112" placeholder="show" required=""
                          value="{{ $lang->show1112 }}">
                      </div>
                    </div>
                                              <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Track Order(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="trackorder1" placeholder="show" required=""
                          value="{{ $lang->trackorder1 }}">
                      </div>
                    </div>
                                              <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Total Qunaty(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="totalq1" placeholder="show" required=""
                          value="{{ $lang->totalq1 }}">
                      </div>
                    </div>
                                              <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Payment Status(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="paymentstat22" placeholder="show" required=""
                          value="{{ $lang->paymentstat22 }}">
                      </div>
                    </div>
                                              <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Unpaid(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="unpaid2222" placeholder="show" required=""
                          value="{{ $lang->unpaid2222 }}">
                      </div>
                    </div>
                                              <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Paid(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="paid00011" placeholder="show" required=""
                          value="{{ $lang->paid00011 }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">Get Trackng Code(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="gtc2222" placeholder="show" required=""
                          value="{{ $lang->gtc2222 }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="left-area">
                          <h4 class="heading">View Tracking(In prodect) *</h4>
                          <p class="sub-heading">(In Any Language)</p>
                        </div>
                      </div>
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="vt2222" placeholder="show" required=""
                          value="{{ $lang->vt2222 }}">
                      </div>
                    </div>
                    <div class="row">
