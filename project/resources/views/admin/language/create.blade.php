                ...
                <div class="col-lg-10">
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="lang534" placeholder="Invoice Number" required=""
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="lang557" placeholder="Name" required=""
                          value="Name">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="lang595" placeholder="Quantity" required=""
                          value="Quantity">
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        <input type="text" class="input-field" name="lang596" placeholder="Line Total" required=""
                          value="Line Total">
                      </div>
                    </div>
