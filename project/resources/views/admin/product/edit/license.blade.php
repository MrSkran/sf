						...
						<form id="geniusform" action="{{route('admin-prod-update',$data->id)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="featured-keyword-area">
										<div class="heading-area">
											<h4 class="title">World Of cdkeys API</h4>
										</div>
							...
							<div id="wock_product_id_container" style="{{ $data->wock_product?'':'display:none' }}" class="row">
								<div class="col-lg-4">
									<div class="left-area">
										...
										<p class="sub-heading">Product ID matching*</p>
									</div>
								</div>
								<div class="col-lg-7">
							...
							<div id="wock_product_id_containerr" style="{{ $data->wock_product?'':'display:none' }}" class="row">
								<div class="col-lg-4">
									<div class="left-area">
										<h4 class="heading">AutoPrice * </h4>
									</div>
								</div>
								<div class="col-lg-7">
														<select class="form-control" name="autoprice" id="wock_product_id">
														<option value="1" {{ $data->autoprice == 1 ? 'selected':'' }}>True</option>
														<option value="0" {{ $data->autoprice == 0 ? 'selected':'' }}>False</option>
														</select>
								</div>
							</div>
