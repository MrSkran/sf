                ...
                <div class="info-meta-3">
                    <ul class="meta-list">
                      ...
                      @if($product->product_type == "affiliate")
                        ...
                        <li class="addtocart">
                          <a href="{{ route('affiliate.product', $product->slug) }}" target="_blank"><i class="icofont-cart"></i> {{ $langg->lang251 }}</a>
                        </li>
                      @else
                        ...
                        <li class="addtocart">
                          <a href="{{ route('product.cart.quickadd',$product->id) }}"><i class="icofont-cart"></i>{{ $langg->lang251 }}</a>
                        </li>
