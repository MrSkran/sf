    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="pages">
          ...
          <li><a href="{{route('front.category',$productt->category->slug)}}">
          @if($langg->rtl == 1)
										{{ $productt->category->name }}@endif
										@if($langg->rtl == 0)
										@if($productt->category->name == 'العاب الكمبيوتر')
										PC Games
										@elseif($productt->category->name == 'ألعاب الاكس بوكس')
										Xbox Games
										@elseif($productt->category->name == 'منتجات السوفت وير')
										Software Products
										@elseif($productt->category->name == 'البطائق')
										Gift Cards
...
<section class="product-details-page">
  <div class="container">
        ...
        <div class="row">
          ...
          <div class="xzoom-container">
            ...
            <div class="product-price">
                  ...
                  @endif
                  @foreach($productt->license_qty as $li_qty)
                  @if($productt->type == 'License' and $li_qty == '0')
                                        <div class="info-meta-3">
                    <ul class="meta-list">
                      <li class="d-block count {{ $productt->type == 'License' ? '' : 'd-none' }}">
    ...
    <input type="radio" name="rating" id="star4"  value="4" /><label class = "full" for="star4" title="Pretty good - 4 stars"></label>
    <input type="radio" name="rating" id="star3"  value="3" /><label class = "full" for="star3" title="Meh - 3 stars"></label>
    <input type="radio" name="rating" id="star2"  value="2" /><label class = "full" for="star2" title="Kinda bad - 2 stars"></label>
    <input type="radio" name="rating" id="star1"  value="1" /><label class = "full" for="star1" title="Sucks big time - 1 star"></label>
</fieldset>                              </ul>
                            </div>
                          </div>
