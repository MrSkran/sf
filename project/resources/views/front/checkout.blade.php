								...
								<div class="content-box">
									...
									<div class="content">
										...
										<div class="ship-diff-addres-area d-none">
											...
											<div class="row">
												<div class="col-lg-6">
													<input class="form-control ship_input" type="email" name="shipping_email"
														id="ship_email" placeholder="{{ $langg->lang154 }}">
												</div>
												<div class="col-lg-6">
										...
										<div class="row">
											<div class="col-lg-12  mt-3">
												<div class="bottom-area">
													<button type="submit" class="mybtn2">{{ $langg->lang753 }}</button>
												</div>
								...
								<div class="content-box">
									<div class="content">
										...
										<div class="row">
											<div class="col-lg-12 mt-3">
												<div class="bottom-area">
													<a href="javascript:;" id="step1-btn"  class="mybtn2 mr-3">{{ $langg->lang757 }}</a>
													<a href="javascript:;" id="step3-btn"  class="mybtn2">{{ $langg->lang753 }}</a>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="payment-information">
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<a class="nav-link payment active" data-show="no" data-form="{{route('paylink.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'paylink','slug2' => 0]) }}" id="v-pills-tab0-tab" data-toggle="pill" href="#v-pills-tab0" role="tab" aria-controls="v-pills-tab0" aria-selected="true">
															<div class="icon">
															...
															<p>
																...
																<small>
													 		<h4 style="color: #000;">
															للدفع عن طريق مدى و فيزا و ماستركارد وابل باي 
                                                            </h4> 
																</small>
															...
															<a class="nav-link payment " data-show="no" data-form="{{route('paypal.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'paypal','slug2' => 0]) }}" id="v-pills-tab1-tab" data-toggle="pill" href="#v-pills-tab1" role="tab" aria-controls="v-pills-tab1" aria-selected="true">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																<p>
														...
														@if($gs->stripe_check == 1)
															<a class="nav-link payment" data-show="yes" data-form="{{route('stripe.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'stripe','slug2' => 0]) }}" id="v-pills-tab2-tab" data-toggle="pill" href="#v-pills-tab2" role="tab" aria-controls="v-pills-tab2" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
														...
														@if($gs->cod_check == 1)
														 @if($digital == 0)
															<a class="nav-link payment" data-show="no" data-form="{{route('cash.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'cod','slug2' => 0]) }}" id="v-pills-tab3-tab" data-toggle="pill" href="#v-pills-tab3" role="tab" aria-controls="v-pills-tab3" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
														...
														@if($gs->is_instamojo == 1)
															<a class="nav-link payment" data-show="no" data-form="{{route('instamojo.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'instamojo','slug2' => 0]) }}"  id="v-pills-tab4-tab" data-toggle="pill" href="#v-pills-tab4" role="tab" aria-controls="v-pills-tab4" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
															...
															@endif
															@if($gs->is_paystack == 1)
															<a class="nav-link payment" data-show="no" data-form="{{route('paystack.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'paystack','slug2' => 0]) }}" id="v-pills-tab5-tab" data-toggle="pill" href="#v-pills-tab5" role="tab" aria-controls="v-pills-tab5" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
...
@foreach($gateways as $gt)
															...
															<a class="nav-link payment" data-show="yes" data-form="{{route('gateway.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'other','slug2' => $gt->id]) }}" id="v-pills-tab{{ $gt->id }}-tab" data-toggle="pill" href="#v-pills-tab5" role="tab" aria-controls="v-pills-tab{{ $gt->id }}" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
													...
													<div class="col-lg-12">
													  <div class="pay-area d-none">
														...
														@foreach($gateways as $gt)
															...
															<div class="tab-pane fade" id="v-pills-tab{{ $gs->id }}" role="tabpanel" aria-labelledby="v-pills-tab{{ $gs->id }}-tab">
										...
										<div class="row">
												<div class="col-lg-12 mt-3">
													<div class="bottom-area">
															...
															<a href="javascript:;" id="step2-btn" class="mybtn2 mr-3">{{ $langg->lang757 }}</a>
															<button type="submit" id="final-btn" class="mybtn2">{{ $langg->lang753 }}</button>
													</div>
