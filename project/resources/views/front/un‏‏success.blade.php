...
@if($order->dp == 1)
                                                        ...
                                                        <div class="billing-add-area">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <h5>{{ $langg->lang292 }}</h5>
                                                                  {{ $langg->lang293 }} : {{$order->currency_sign}}{{ round($order->pay_amount * $order->currency_value , 2) }}<br>
                                                                {{ $langg->lang294 }} : {{$order->method}}<br>
                                                                    {{ $langg->adapter_name }} : {{$order->adapter_name}}<br>{{ $langg->transfer_amount }} : {{$order->transfer_amount}}<br>{{ $langg->transfer_date }} : {{$order->transfer_date}}<br>
                                                                    ...
                                                                    @if($order->method != "Cash On Delivery")
                                                                        ...
                                                                        @endif
                                                                        {{ $langg->lang296 }} <p id="ttn">{{$order->transaction_id}}</p>
