...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
    ...
    public function extraIndex(Request $request)
    {
        ...
        $partners = DB::table('partners')->get();
        $discount_products =  Product::where('is_discount','=',1)->where('status','=',1)->take(8)->get();
        $feature_products =  Product::where('featured','=',1)->where('status','=',1)->take(10)->get();
        $best_products = Product::where('best','=',1)->where('status','=',1)->take(12)->get();
        $top_products = Product::where('top','=',1)->where('status','=',1)->take(12)->get();;
