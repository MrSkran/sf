...
// -------------------------------- CATEGORY SECTION ----------------------------------------
    ...
    public function category(Request $request,$slug)
    {
        ...
        $cats = (new Collection(Product::filterProducts($oldcats)))->paginate(21);
        // Search By Price
    ...
    if(!empty($request->min) || !empty($request->max))
    {
        ...
        $cats = (new Collection(Product::filterProducts($oldcats)))->sortBy('price')->paginate(21);
        if($request->ajax()){
    ...
    if( !empty($request->sort) )
    {
        ...
        $cats = (new Collection(Product::filterProducts($oldcats)))->sortByDesc('price')->paginate(21);
        }
        if($request->ajax()){
    ...
    public function tag(Request $request, $tag)
    {
       ...
       $products = (new Collection(Product::filterProducts($oldcats)))->paginate(21);
    ...
    if(!empty($request->min) || !empty($request->max))
    {
       ...
       $products = (new Collection(Product::filterProducts($oldcats)))->sortBy('price')->paginate(21);
        if($request->ajax()){
    ...
    if( !empty($request->sort) )
    {
        ...
        $products = (new Collection(Product::filterProducts($oldcats)))->sortByDesc('price')->paginate(21);
        }
        if($request->ajax()){
